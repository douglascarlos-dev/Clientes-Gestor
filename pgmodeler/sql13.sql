...
-- object: public.photo_remove_function | type: FUNCTION --
-- DROP FUNCTION IF EXISTS public.photo_remove_function(character varying) CASCADE;
CREATE FUNCTION public.photo_remove_function (cpf_ character varying)
	RETURNS integer
	LANGUAGE plpgsql
	VOLATILE 
	CALLED ON NULL INPUT
...
$$;
-- ddl-end --
ALTER FUNCTION public.photo_remove_function(character varying) OWNER TO postgres;
-- ddl-end --
