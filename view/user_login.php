...
<html lang="pt-br">
  ...
  <div class="mx-auto text-center col-md-8 order-md-1">
    ...
    <p>Software Web para cadastro de clientes com URL amigável usando PHP Orientado a Objetos, MVC e banco de dados Postgresql com PDO, CAPTCHA, PDF e upload de imagem.</p>
    <p>Demonstração
    <br>
    <b>Usuário:</b> admin
    <br>
