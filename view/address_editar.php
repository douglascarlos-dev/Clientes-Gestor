...
<form name="register" action="<?php echo URLROOT; ?>/address/atualizar/<?php echo $cpf; ?>" method="post">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputCategoria" name="address_category" value="<?php echo $address->getAddressCategory(); ?>" readonly>
    </div>
    <div class="form-group col-md-4">
    <label for="inputCEP">CEP</label>
      <input type="text" class="form-control" id="inputCEP" name="zip_code" maxlength="8" value="<?php echo htmlspecialchars($address->getZipCode(), ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <div class="form-group col-md-3">
    <label for="inputTipo">Tipo (Avenida, Rua, etc)</label>
      <input type="text" class="form-control" id="inputTipo" name="type" maxlength="20" value="<?php echo htmlspecialchars($address->getType(), ENT_QUOTES, 'UTF-8'); ?>">
    </div>
    <div class="form-group col-md-6">
      <label for="inputNome">Nome</label>
      <input type="text" class="form-control" id="inputNome" name="name" maxlength="100" value="<?php echo htmlspecialchars($address->getName(), ENT_QUOTES, 'UTF-8'); ?>">
    </div>
    <div class="form-group col-md-3">
      <label for="inputNumero">Número</label>
      <input type="text" class="form-control" id="inputNumero" name="number" maxlength="10" value="<?php echo htmlspecialchars($address->getNumber(), ENT_QUOTES, 'UTF-8'); ?>">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputBairro">Bairro</label>
      <input type="text" class="form-control" id="inputBairro" name="neighborhood" maxlength="100" value="<?php echo htmlspecialchars($address->getDistrict(), ENT_QUOTES, 'UTF-8'); ?>">
    </div>
    <div class="form-group col-md-6">
      <label for="inputCidade">Cidade</label>
      <input type="text" class="form-control" id="inputCidade" name="city" maxlength="100" value="<?php echo htmlspecialchars($address->getCity(), ENT_QUOTES, 'UTF-8'); ?>">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-2">
      <label for="inputUF">UF</label>
      <input type="text" class="form-control" id="inputUF" name="state" maxlength="2" style="text-transform:uppercase" value="<?php echo htmlspecialchars($address->getState(), ENT_QUOTES, 'UTF-8'); ?>">
    </div>

    <div class="form-group col-md-10">
      <label for="inputComplemento">Complemento</label>
      <input type="text" class="form-control" id="inputComplemento" name="complement" maxlength="60" value="<?php echo htmlspecialchars($address->getComplement(), ENT_QUOTES, 'UTF-8'); ?>">
    </div>
  </div>
