...
<div class="card">
<div class="card-body">
<form name="register" action="<?php echo URLROOT; ?>/phone/atualizar/<?php echo $cpf; ?>" method="post">
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputNome">Descrição</label>
      <input type="text" class="form-control" id="inputTipo" name="type" value="<?php echo $phone->getType(); ?>" readonly>
    </div>
    <div class="form-group col-md-6">
      <label for="inputTelefone">Telefone</label>
      <input type="tel" class="form-control" id="inputTelefone" name="phone" maxlength="11" value="<?php echo $phone->getPhone(); ?>">
    </div>
  </div>
